    ...
    def _call_local_mock(self, prompt: str, system_prompt: Optional[str], temperature: float) -> str:
        ...
        knowledge_base = [
            ...
            {"keys": ["galileo at jupiter and venera 7 at venus"],
             "grounded": "Galileo released an atmospheric probe that descended 150 km into Jupiter before melting, while Venera 7 soft-landed on Venus and transmitted telemetry for 45 minutes.",
            ...
            {"keys": ["voyager 1 and voyager 2 at their respective crossing dates"],
             "grounded": "Voyager 1 and Voyager 2 crossed the heliopause at approximately 130 AU and 125 AU respectively beyond the solar wind.",
